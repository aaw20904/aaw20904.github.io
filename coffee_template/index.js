...
"use strict";
module.exports = __webpack_require__.p + "res/defbbedd6ca0488f4622.svg";
...
/* harmony import */ var _bckg_arrow2_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(266);
/* harmony import */ var _node_modules_lax_js_lib_lax__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(178);
/* harmony import */ var _node_modules_lax_js_lib_lax__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_node_modules_lax_js_lib_lax__WEBPACK_IMPORTED_MODULE_2__);
...
window.bootstrap = __webpack_require__(625);
  ...
  const n2 = document.querySelectorAll('.arrow');
  n2[0].src= _bckg_arrow2_svg__WEBPACK_IMPORTED_MODULE_1__;

 window.onload = function() {
  _node_modules_lax_js_lib_lax__WEBPACK_IMPORTED_MODULE_2___default().init();
   // Add a driver that we use to control our animations
   _node_modules_lax_js_lib_lax__WEBPACK_IMPORTED_MODULE_2___default().addDriver('scrollY', function () {
    return window.scrollY
  })

  // Add animation bindings to elements
  _node_modules_lax_js_lib_lax__WEBPACK_IMPORTED_MODULE_2___default().addElements('.arrow', {
    scrollY: {
      translateY: [
        [0, 'pageHeight/4'],
        [0, '(screenHeight * -0.6)'],
